...
#define MAXINFILE     1024	  //maximum of input files
#define MAXOUTFILE    1024	  //maximum of output files
...
typedef struct {        /* processing options type */
    ...
    int intpref;        /* interpolate reference obs (for post mission)插值参考obs（用于后期任务）??? */
    ...
    int  syncsol;       /* solution sync mode (0:off,1:on) 解决方案同步模式*/
